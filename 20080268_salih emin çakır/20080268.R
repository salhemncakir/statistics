...
# Soru 1a --- 
# -------------------------------------------------------------------------- ###
https://github.com/salhemncakir/statistics.git
# -------------------------------------------------------------------------- ###
# Soru 2a ----
# -------------------------------------------------------------------------- ###
R
...
# Soru 3b ----
# -------------------------------------------------------------------------- ###
 tüm satırları ve dat1'deki ve dat2'deki tüm sütunları döndürerek bir tibble olan "dat3" adlı yeni bir tibble oluşturmak için `inner_join()` fonksiyonu
...
# -------------------------------------------------------------------------- ###
 ...
 `myresult` değişkeni aşağıdaki gibi 
...
pnorm(1, mean = 2, sd = 3/5)
 ...
 μ'ye 2 değeri atanır ve σ'nın tersi (1/σ) olan 3/5 değeri atanır.
